    ...
    protected function getIndexedFields($changes) {
        ...
        if (empty($changes['load_defaults'])) {
            ...
            return [
                ...
                'show_selected_options_first' => new Zend_Db_Expr($db->quoteInto("COALESCE(`fge`.`show_selected_options_first`, ?)", $this->configuration->getDefaultShowSelectedOptionsFirst())),
            ...
            return [
                ...
                'show_selected_options_first' => new Zend_Db_Expr($db->quoteInto("?", $this->configuration->getDefaultShowSelectedOptionsFirst())),
